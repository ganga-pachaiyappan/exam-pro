...
import {
  BookOpen, LayoutDashboard, FileText, Award, Settings, LogOut,
  Users, Menu, X, CreditCard
} from "lucide-react";
      ...
      <aside className={cn(
        ...
        <div className="p-3 border-t border-border">
          <div className="flex items-center gap-3 px-3 py-2 mb-2">
            {user?.photo_url ? (
              <img src={`${API_BASE}${user.photo_url}`} alt="" className="h-8 w-8 rounded-full object-cover" />
            ) : (
