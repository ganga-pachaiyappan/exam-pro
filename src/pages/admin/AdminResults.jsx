...
const AdminResults = () => {
    ...
    const examScores = {};
    attempts.forEach((a) => {
        if (!examScores[a.exam_title])
            examScores[a.exam_title] = [];
    ...
    return (<DashboardLayout>
      <div className="space-y-6">
        ...
        {attempts.length === 0 ? (<div className="glass-card p-12 text-center">
            ...
            <div className="glass-card overflow-hidden lg:col-span-2">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {attempts.slice().reverse().map((a) => (<tr key={a.id} className="border-t border-border">
