...
const ExamList = () => {
    ...
    return (<DashboardLayout>
      <div className="space-y-6">
        ...
        {exams.length === 0 ? (<div className="glass-card p-12 text-center">
            ...
            {exams.map((exam, i) => (<motion.div key={exam.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }} className="stat-card flex flex-col">
