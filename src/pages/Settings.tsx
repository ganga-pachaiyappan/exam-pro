        ...
        <div className="glass-card p-6">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              {user?.photo_url ? (
                <img src={`${API_BASE}${user.photo_url}`} alt="" className="h-20 w-20 rounded-full object-cover" />
              ) : (
              ...
              <button
                ...
                className="absolute -bottom-1 -right-1 h-8 w-8 rounded-full bg-primary flex items-center justify-center text-primary-foreground"
              >
